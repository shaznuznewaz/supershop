<div class="container-fluid">
    <div class="row">
        <div class="col-xl-3 col-lg-3 col-md-12 col-12 animated p-2 ">
                    ...
                    <div class="row">
                         <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                ...
                                <p class="mb-0 text-sm mt-3">Product</p>
                            </div>  
                    ...
                    <div class="row">
                        <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                ...
                                <p class="mb-0 text-sm mt-3">Category</p>
                            </div>
                        </div>
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
                    ...
                    <div class="row">
                        <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                ...
                                <p class="mb-0 text-sm mt-3">Invoice</p>
                            </div>
                        </div>
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
